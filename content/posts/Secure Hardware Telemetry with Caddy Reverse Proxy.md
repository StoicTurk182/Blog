...
| Directive | Purpose |
|-----------|---------|
| `100.69.66.60:8086` | Bind only to Tailscale interface on port 8086 |
...
```powershell
Test-NetConnection -ComputerName 100.69.66.60 -Port 8086
```
...
By binding Caddy exclusively to the Tailscale IP (`100.69.66.60`), the service is inaccessible from:
