...
1. **Lesson 1**: HelpDesk is extremely hard and this is also dependant on the type of MSP you work for, most IT professionals start here. That is for a good reason, you get massive exposure to many intersecting technologies.  
2. **Lesson 2**: Telephony based technologies have a steep learning curve but it is worth IT if you ever want to pick one self contained system 
that holds the entire OSI model in one place this would be it. You could easily Specialise in this one area. 
3. **Lesson 3**: There will always be more ticket never try to beat the queue it will always win, prioritize and work the problems.
4. **Lesson 4**:  Changing role is really hard more so when you are kind of happy where you are but is essential to broaden perspective. 
